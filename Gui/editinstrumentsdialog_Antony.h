#ifndef EDITINSTRUMENTSDIALOG_ANTONY_H
#define EDITINSTRUMENTSDIALOG_ANTONY_H
...
class EditInstrumentsDialog_Antony : public QDialog
{
    Q_OBJECT

public:
    explicit EditInstrumentsDialog_Antony(QWidget *parent = 0);
    ~EditInstrumentsDialog_Antony();
...
#endif // EDITINSTRUMENTSDIALOG_ANTONY_H
