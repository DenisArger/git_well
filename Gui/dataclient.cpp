...
dataClient::dataClient(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::dataClient)
{
    ui->setupUi(this);
...
void dataClient::setupModel(const QStringList &headers)
{
    ...
    model->setQuery( QString("SELECT ClientsCard.ID,ClientsCard.service,Region.region, District.district, ClientsCard.locality, ClientsCard.street, Diameter.numberDiameter,\
                                ClientsCard.mobilPhone, ClientsCard.surname, ClientsCard.name_, ClientsCard.patronymic FROM ((ClientsCard INNER JOIN Diameter \
    ON ClientsCard.id_diameter = Diameter.id) INNER JOIN District ON ClientsCard.id_district = District.id) INNER JOIN Region ON District.id_region = Region.id;"),
                     dataBase.getDatase());
...
void dataClient::on_closeButton_clicked()
{
    close();
}


void dataClient::fillRegion()
{
...
void dataClient::fillDistrict_FULL()
{
    ui->districtCombo->clear();
...
void dataClient::on_filterButton_clicked()
{
    QString queryTXT= QString("SELECT ClientsCard.ID,ClientsCard.service,Region.region, District.district, ClientsCard.locality, ClientsCard.street, Diameter.numberDiameter,\
                              ClientsCard.mobilPhone, ClientsCard.surname, ClientsCard.name_, ClientsCard.patronymic\
...
QString dataClient::filterLocation()
{
    int id_region=ui->regionCombo->currentIndex();
...
QString dataClient::filterDiameter()
{
    int id_diameter=ui->diameterCombo->currentIndex();
    QString  textFilter;
    if(parsingLocation())
        textFilter=QString(" AND ClientsCard.id_diameter=%1").arg(id_diameter);
    else
        textFilter=QString(" WHERE ClientsCard.id_diameter=%1").arg(id_diameter);

    return textFilter;

}

QString dataClient::filterPump()
{
    QString  textFilter;
...
QString dataClient::filterService()
{
    QString  textFilter;
...
int dataClient::parsingLocation()
{
    int parsing;
    int id_region=ui->regionCombo->currentIndex();
    int id_district=ui->districtCombo->currentIndex();
...
int dataClient::parsingPersonale()
{
    int parsing;
...
QString dataClient::filterPersonale()
{
    QString  textFilter;
    QString surname= ui->surnameLineEdit->text();
    QString name= ui->nameLineEdit->text();
...
void dataClient::on_clearFilterButton_clicked()
{
    model->setQuery( QString("SELECT ClientsCard.ID,ClientsCard.service,Region.region, District.district, ClientsCard.locality, ClientsCard.street, Diameter.numberDiameter,\
                                ClientsCard.mobilPhone, ClientsCard.surname, ClientsCard.name_, ClientsCard.patronymic FROM ((ClientsCard INNER JOIN Diameter \
    ON ClientsCard.id_diameter = Diameter.id) INNER JOIN District ON ClientsCard.id_district = District.id) INNER JOIN Region ON District.id_region = Region.id;"),
...
void dataClient::on_tableView_doubleClicked(const QModelIndex &index)
{
...
personale dataClient::fillDataClient(int ID_DataClient)
{
    QString query;
    personale pers;
    query=QString("SELECT ClientsCard.surname, ClientsCard.name_, ClientsCard.patronymic, ClientsCard.mobilPhone,\
                  ...
                  ClientsCard.id_diameter, ClientsCard.pump, ClientsCard.service, ClientsCard.dataBegin, ClientsCard.dataEnd, ClientsCard.notes\
